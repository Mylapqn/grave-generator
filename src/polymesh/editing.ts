import { BoxGeometry, Intersection, Mesh, MeshBasicMaterial, Vector3, Group } from "three";
import { MoveOperation, Operation } from "./operations";
...
export class Gizmo {
    ...
    public static update(intersect:Intersection|null) {
